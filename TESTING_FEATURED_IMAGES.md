...
- [ ] Check database: `SELECT post_id, meta_value FROM wp_postmeta WHERE meta_key = '_thumbnail_id' AND post_id IN (SELECT ID FROM wp_posts WHERE post_type = 'floor_plan')`
