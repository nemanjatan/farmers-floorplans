      ...
      ?>
        <table class="form-table">
            <tr>
                ...
                <td><input type="text" id="ffp_source_id" name="ffp_source_id"
                           value="<?php echo esc_attr( $source_id ); ?>" class="regular-text" readonly/></td>
            </tr>
            <tr>
                <th><label for="ffp_building">Building</label></th>
                <td><input type="text" id="ffp_building" name="ffp_building"
                           value="<?php echo esc_attr( $building ); ?>" class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_address">Address</label></th>
                <td><input type="text" id="ffp_address" name="ffp_address" value="<?php echo esc_attr( $address ); ?>"
                           class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_price">Price</label></th>
                <td><input type="number" id="ffp_price" name="ffp_price" value="<?php echo esc_attr( $price ); ?>"
                           class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_bedrooms">Bedrooms</label></th>
                <td><input type="text" id="ffp_bedrooms" name="ffp_bedrooms"
                           value="<?php echo esc_attr( $bedrooms ); ?>" class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_bathrooms">Bathrooms</label></th>
                <td><input type="text" id="ffp_bathrooms" name="ffp_bathrooms"
                           value="<?php echo esc_attr( $bathrooms ); ?>" class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_sqft">Square Feet</label></th>
                <td><input type="number" id="ffp_sqft" name="ffp_sqft" value="<?php echo esc_attr( $sqft ); ?>"
                           class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_available">Available</label></th>
                <td><input type="text" id="ffp_available" name="ffp_available"
                           value="<?php echo esc_attr( $available ); ?>" class="regular-text"/></td>
            </tr>
            <tr>
                <th><label for="ffp_active">Active</label></th>
                <td>
                    <input type="checkbox" id="ffp_active" name="ffp_active"
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" id="ffp_featured" name="ffp_featured"
            ...
            <tr>
                ...
                <td><input type="url" id="ffp_source_url" name="ffp_source_url"
                           value="<?php echo esc_attr( $source_url ); ?>" class="regular-text"/></td>
            </tr>
        </table>
      <?php
    }
