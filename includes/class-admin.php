            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="url" id="ffp_list_url" name="ffp_list_url" value="<?php echo esc_attr(get_option('ffp_list_url', 'https://cityblockprop.appfolio.com/listings')); ?>" class="regular-text" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="ffp_building_filter" name="ffp_building_filter" value="<?php echo esc_attr(get_option('ffp_building_filter', 'Farmer\'s Exchange 580 E Broad St.')); ?>" class="regular-text" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="time" id="ffp_sync_time" name="ffp_sync_time" value="<?php echo esc_attr(get_option('ffp_sync_time', '03:00')); ?>" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" id="ffp_auto_create_page" name="ffp_auto_create_page" value="1" <?php checked(get_option('ffp_auto_create_page', true)); ?> />
